...
/* Upstream this offered a link to its own issue tracker, fetched from
 * /api/ui-config so the URL was auditable rather than hardcoded. This
 * deployment has no such endpoint, and pointing a company's own platform at
 * somebody else's tracker is not a link worth showing — so there is no link,
 * and the callout explains the gap instead. */
